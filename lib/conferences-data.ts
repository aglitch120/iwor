...
export const CONFERENCES_2026: Conference[] = [
  ...
  { id: 'naika-2026', society: '日本内科学会', societyShort: '内科', specialtyArea: '内科', tier: 'basic',
    ...
    startDate: '2026-04-10', endDate: '2026-04-12', venue: '東京国際フォーラム', city: '東京', url: 'https://www.naika.or.jp/meeting/123-info/', year: 2026, abstractDeadline: '2026-01-15' },
  ...
  { id: 'riha-2026', society: '日本リハビリテーション医学会', societyShort: 'リハビリ', specialtyArea: 'リハビリ', tier: 'basic',
    ...
    startDate: '2026-06-04', endDate: '2026-06-07', venue: '福岡国際会議場/マリンメッセ福岡B', city: '福岡', url: 'https://www.congre.co.jp/63jarm2026/', year: 2026, abstractDeadline: '2026-03-15' },
  { id: 'hifuka-2026', society: '日本皮膚科学会', societyShort: '皮膚科', specialtyArea: '皮膚科', tier: 'basic',
    ...
    startDate: '2026-06-11', endDate: '2026-06-14', venue: '国立京都国際会館', city: '京都', url: 'https://jda125.jda-conv.jp/', year: 2026, abstractDeadline: '2026-03-20' },
  { id: 'seishin-2026', society: '日本精神神経学会', societyShort: '精神科', specialtyArea: '精神科', tier: 'basic',
    ...
    startDate: '2026-06-18', endDate: '2026-06-20', venue: 'パシフィコ横浜ノース', city: '横浜', url: 'https://www.congre.co.jp/jspn122/', year: 2026, abstractDeadline: '2026-03-25' },
  ...
  { id: 'noshinkei-2026', society: '日本脳神経外科学会', societyShort: '脳神経外科', specialtyArea: '脳神経外科', tier: 'basic',
    ...
    startDate: '2026-10-21', endDate: '2026-10-23', venue: '札幌文化芸術劇場hitaru', city: '札幌', url: 'https://www.congre.co.jp/jns2026/', year: 2026, abstractDeadline: '2026-06-30' },
  { id: 'kyukyu-2026', society: '日本救急医学会', societyShort: '救急科', specialtyArea: '救急科', tier: 'basic',
    ...
    startDate: '2026-10-27', endDate: '2026-10-29', venue: '出島メッセ長崎', city: '長崎', url: 'https://site2.convention.co.jp/jaam54/', year: 2026, abstractDeadline: '2026-07-15' },
  ...
  { id: 'rinsho-kensa-2026', society: '日本臨床検査医学会', societyShort: '臨床検査', specialtyArea: '臨床検査', tier: 'basic',
    ...
    startDate: '2026-12-17', endDate: '2026-12-20', venue: '幕張メッセ', city: '千葉', url: 'https://square.umin.ac.jp/jslm73/', year: 2026, abstractDeadline: '2026-08-31' },
