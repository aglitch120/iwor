...
- [ ] **マッチング: 病院DB改修**（評価項目充実/加重平均/倍率グラフ/マッチ度モザイク）
- [ ] **マッチング: 履歴書の書き方チェックリスト**
- [ ] **入院中トラブル対応追加**（ショック/SpO2低下/頻脈徐脈/自己抜去/せん妄/転倒/血糖異常/アナフィラキシー/アルコール離脱/不眠）
- [ ] **ER主訴追加**: ショック（血圧低下）、便秘
- [ ] **検査読影UI統合**: CT→頭胸腹骨盤統合、エコー→タブ切替
