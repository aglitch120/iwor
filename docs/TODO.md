...
- [ ] **免責ポップアップ**: ツール初回利用時（医学生/医師確認 + 免責 + 間違い連絡促し + 同意）
- [ ] **利用規約・プライバシーポリシー作成**: 会員登録時の同意チェック用
- [ ] **サインアップ画面**: プロフィール（大学名等）を削除（障壁除去）
- [ ] **会員登録後プロフィール収集**: 必須（医学生/医師）+ 任意（大学名/卒業年/病院規模/診療科）
- [ ] **マイページ改修**: チェックマーク削除 + 個人情報表示 + パスワード変更 + 7アプリリンク
