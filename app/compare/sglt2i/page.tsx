...
const data: CompareData = {
  ...
  drugs: [
    {
      ...
      renalAdjust: 'eGFR < 20: 新規投与は推奨されない（心不全・CKD適応では継続可能な場合あり）',
    ...
    },
    {
      ...
      renalAdjust: 'eGFR < 25: 新規投与は推奨されない（心不全・CKD適応では継続可能な場合あり）',
    ...
    },
    {
      ...
      renalAdjust: 'eGFR < 30: 効果減弱のため推奨されない',
  ...
  seoContent: [
    ...
    { heading: 'ケトアシドーシスのリスク', text: 'SGLT2阻害薬の重要な副作用として正常血糖ケトアシドーシス（euDKA）があります。血糖は正常〜軽度上昇にもかかわらずケトン産生が亢進するため、発見が遅れやすい点が問題です。手術前・脱水時・シックデイには休薬が推奨されます。' },
