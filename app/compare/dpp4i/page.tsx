...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'ビルダグリプチン', brand: 'エクア', specs: '50mg', indication: '2型糖尿病', halfLife: '約3時間', metabolism: '加水分解（非CYP）→ 腎排泄', renalAdjust: '中等度以上の腎障害: 慎重投与', features: '1日2回投与。CYP非依存で相互作用少。肝機能障害の報告あり → 定期的な肝機能チェック推奨', contraindication: '重症ケトーシス、糖尿病性昏睡、肝機能障害', evidence: '' },
