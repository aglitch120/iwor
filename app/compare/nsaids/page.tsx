...
const data: CompareData = {
  ...
  drugs: [
    ...
    { generic: 'セレコキシブ', brand: 'セレコックス', specs: '100mg/200mg', indication: '関節リウマチ・変形性関節症の疼痛', halfLife: '約6-12時間', metabolism: 'CYP2C9（主）', renalAdjust: '重度腎障害: 推奨されない', features: 'COX-2選択的阻害薬。消化管障害リスクが低い（CLASS試験）。心血管リスクは他のNSAIDsと同等〜やや高い。スルホンアミド骨格', contraindication: 'スルホンアミドアレルギー、消化性潰瘍、重篤な肝腎障害・心不全', evidence: 'CLASS試験、PRECISION試験' },
