...
const data: CompareData = {
  ...
  seoContent: [
    { heading: 'スタチンの分類と使い分け', text: 'スタチンはLDL低下作用の強さからストロングスタチン（ロスバスタチン・アトルバスタチン・ピタバスタチン）とスタンダードスタチン（プラバスタチン・シンバスタチン・フルバスタチン）に分類されます。二次予防やハイリスク患者にはストロングスタチンが推奨されます。' },
