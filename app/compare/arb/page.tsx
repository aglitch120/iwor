...
const data: CompareData = {
  ...
  seoContent: [
    ...
    { heading: 'ARBとACE阻害薬の選択', text: 'ARBとACE阻害薬は同じRAS系を阻害しますが、ARBは空咳の副作用が少ない利点があります。ACE阻害薬は心不全・MI後のエビデンスが豊富で、コスト面でも有利です。ARBとACE阻害薬の併用はONTARGET試験で腎障害増加が示され、原則推奨されません。' },
