...
const tools = [
  ...
  { href: '/tools/interpret/ct', name: 'CT読影（頭部・胸部）', desc: '頭部・胸部CTの系統的評価。脳実質→脳室→骨・軟部 / 肺実質→胸膜→縦隔。タブ切替で評価。', badge: '', live: true },
  { href: '/tools/interpret/echo', name: 'エコー読影（心臓・腹部・頸動脈）', desc: '心エコー（LVEF・壁運動・弁膜症）、腹部エコー（肝・胆・膵・腎・脾）、頸動脈エコー（IMT・狭窄）をタブ切替。', badge: '', live: true },
