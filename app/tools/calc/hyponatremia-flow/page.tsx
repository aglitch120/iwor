    ...
    <CalculatorLayout
      ...
      explanation={
        <section className="space-y-4 text-sm text-muted">
          <h2 className="text-base font-bold text-tx">低Na血症の診断アルゴリズム</h2>
          <p>Step 1: 血漿浸透圧で高張・等張・低張に分類。Step 2: 低張性なら尿浸透圧で腎の希釈能を評価。Step 3: 体液量と尿中Na濃度で原因を絞り込みます。</p>
          <h2 className="text-base font-bold text-tx">緊急対応</h2>
          <p>重症症候性（けいれん・意識障害）: 3% NaCl 100-150mL を10-20分で投与（1-2 mEq/L上昇目標）。補正速度は24時間で8 mEq/L以内（ODS予防）。慢性低Naでは特に緩徐な補正が重要です。</p>
        </section>
      }
      relatedTools={[]}
      references={[
        ...
        { text: 'Hoorn EJ, Zietse R. Diagnosis and treatment of hyponatremia. Am J Kidney Dis 2017;69:148-159' },
      ]}
    >
