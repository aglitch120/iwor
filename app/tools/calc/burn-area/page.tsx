    ...
    <CalculatorLayout
      ...
      explanation={
        <section className="space-y-4 text-sm text-muted">
          <h2 className="text-base font-bold text-tx">9の法則とは</h2>
          <p>Wallaceの9の法則は、成人の体表面積を9%の倍数で概算する方法です。小児では頭部が大きく下肢が小さいため修正値を使用します。</p>
          <h2 className="text-base font-bold text-tx">Parkland公式</h2>
          <p>受傷後24時間の輸液量 = 4 mL × 体重(kg) × TBSA(%)。前半8時間で半量、残り16時間で半量を投与します。尿量0.5-1 mL/kg/hを目標に調整します。</p>
          <h2 className="text-base font-bold text-tx">専門施設搬送基準</h2>
          <p>成人TBSA≧15%、小児TBSA≧10%、気道熱傷、顔面・手・足・会陰の深達性熱傷、化学・電撃傷はBurn Centerへの搬送を考慮します。</p>
        </section>
      }
      relatedTools={[]}
      references={[
