...
const cancers: CancerDef[] = [
  ...
  { name: '食道癌', edition: 'UICC第8版 (2017)',
    ...
    rules: [
      ...
      { t:['T1a','T1b','T2'], n:['N2'], m:['M0'], stage:'III' },
      { t:['T2'], n:['N1'], m:['M0'], stage:'III' },
      { t:['T3'], n:['N1','N2'], m:['M0'], stage:'III' },
      { t:['T4a'], n:['N0'], m:['M0'], stage:'IIIA' },
      { t:['T4a'], n:['N1','N2'], m:['M0'], stage:'IIIB' },
