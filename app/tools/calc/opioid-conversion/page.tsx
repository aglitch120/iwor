  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      result={<>
        ...
        <div className="mt-3 p-3 bg-dnl border border-dnb rounded-xl text-xs text-dn font-medium leading-relaxed">⚠️ この換算値は参考値です。実際の投与量は緩和医療専門医が個別に判断します。フェンタニルパッチは72時間持続製剤であり、注射との換算には注意が必要です</div>
      </>}
