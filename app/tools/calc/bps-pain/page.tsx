...
export default function BPSPage(){
  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<section className="space-y-4 text-sm text-muted"><h2 className="text-base font-bold text-tx">BPSとは</h2><p>Behavioral Pain Scale。鎮静下の挿管患者の疼痛を3項目（表情/上肢/呼吸器順応）で評価。3-12点。≧6で有意な疼痛。CPOTとともにPADISガイドラインで推奨。</p></section>}
