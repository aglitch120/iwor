  ...
  return (
      ...
      result={result && (
        <ResultCard
          ...
          details={[
            ...
            ...(result.tgWarning ? [{ label: '⚠️ 注意', value: 'TG≧400: 直接法LDLを推奨' }] : []),
          ]}
        />
      )}
      explanation={
    ...
    >
      <div className="space-y-4">
        ...
        <NumberInput id="tg" label="TG（中性脂肪）" unit="mg/dL" hint="空腹時採血を推奨。400以上では直接法LDLを使用" value={tg} onChange={setTg} min={10} max={3000} step={1} />
      </div>
    </CalculatorLayout>
  )
}
