...
export default function PSIPortPage(){
  ...
  const result=useMemo(()=>{
    ...
    if(score<=50){cls='I';label='Class I (≦50): 死亡率<0.1% ※年齢≤50歳かつ併存疾患・バイタル異常なしの臨床基準も必要（Fine 1997）';sev='ok'}
    else if(score<=70){cls='II';label='Class II (51-70): 死亡率0.6%';sev='ok'}
    else if(score<=90){cls='III';label='Class III (71-90): 死亡率2.8%';sev='wn'}
    else if(score<=130){cls='IV';label='Class IV (91-130): 死亡率8.2%';sev='wn'}
    else{cls='V';label='Class V (>130): 死亡率29.2%。最終判断は担当医による';sev='dn'}
