...
export default function NRS2002Page(){
  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<section className="space-y-4 text-sm text-muted"><h2 className="text-base font-bold text-tx">NRS 2002とは</h2><p>Nutritional Risk Screening 2002。入院患者の栄養リスクを評価。栄養状態(0-3)+疾患重症度(0-3)+年齢補正(70歳以上+1)=最大7点。≧3で栄養介入を推奨。ESPENの推奨ツール。</p></section>}
