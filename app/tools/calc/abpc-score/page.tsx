...
export default function AbpcScorePage(){
  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<section className="space-y-4 text-sm text-muted"><h2 className="text-base font-bold text-tx">非定型肺炎スコアとは</h2><p>日本呼吸器学会の市中肺炎診療ガイドラインで推奨。6項目中4項目以上で非定型肺炎（マイコプラズマ等）を疑い、マクロライド系を選択。3項目以下は細菌性肺炎としてβラクタム系。感度78%、特異度93%。</p></section>}
