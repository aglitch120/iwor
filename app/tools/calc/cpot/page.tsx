...
export default function CPOTPage(){
  ...
  return(
    <CalculatorLayout slug={toolDef.slug} title={toolDef.name} titleEn={toolDef.nameEn} description={toolDef.description}
      ...
      explanation={<section className="space-y-4 text-sm text-muted"><h2 className="text-base font-bold text-tx">CPOTとは</h2><p>Critical-Care Pain Observation Tool。自己申告できないICU患者の疼痛を4項目（表情/身体動作/筋緊張/人工呼吸器順応or発声）で客観的に評価。≧3で有意な疼痛。PADISガイドラインで推奨。</p></section>}
