...
const grades = [
  ...
  { value: 'A', label: 'Grade A: 粘膜障害が5mm以下で粘膜ヒダに限局', severity: 'wn' as const, detail: '軽症 — PPI標準用量を検討' },
  { value: 'B', label: 'Grade B: 粘膜障害が5mm超だが粘膜ヒダ間に連続しない', severity: 'wn' as const, detail: '中等症 — PPI標準用量での治療' },
  { value: 'C', label: 'Grade C: 粘膜障害が粘膜ヒダ間に連続するが全周の75%未満', severity: 'dn' as const, detail: '重症 — PPI倍量・長期維持療法を考慮' },
  { value: 'D', label: 'Grade D: 粘膜障害が全周の75%以上', severity: 'dn' as const, detail: '最重症 — PPI倍量・外科的治療を考慮' },
]
