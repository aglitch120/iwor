...
const DRUGS: Drug[] = [
  ...
  { id:'ne', name:'ノルアドレナリン', nameEn:'Norepinephrine', category:'vasopressor',
    ...
    notes:'通常0.05-0.3μg/kg/min。末梢ルートでも短時間は可。'},
  ...
  { id:'dopamine', name:'ドパミン', nameEn:'Dopamine', category:'vasopressor',
    ...
    dilutions:[{label:'200mg/200mL（原液）',drugMg:200,totalMl:200},{label:'150mg/50mL（シリンジ）',drugMg:150,totalMl:50},{label:'600mg/200mL',drugMg:600,totalMl:200}],
  ...
  { id:'dobutamine', name:'ドブタミン', nameEn:'Dobutamine', category:'inotrope',
    ...
    notes:'通常2-10μg/kg/min。血管拡張で血圧低下に注意。'},
  ...
  { id:'nicardipine', name:'ニカルジピン', nameEn:'Nicardipine', category:'antihypertensive',
    ...
    notes:'Ca拮抗薬。5分毎に0.5-1μg/kg/min増量。'},
