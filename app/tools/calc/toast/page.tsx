...
const types=[
  {value:'laa',label:'大血管アテローム硬化性（LAA）',desc:'頸動脈/頭蓋内動脈の50%以上狭窄。治療選択は担当医が判断',sev:'wn' as const},
  {value:'svo',label:'小血管閉塞性（SVO/ラクナ）',desc:'径<15mm + ラクナ症候（純粋運動性片麻痺等）の典型的臨床症候が必要。治療選択は担当医が判断',sev:'ok' as const},
  {value:'ce',label:'心原性塞栓（CE）',desc:'AF等が塞栓源。治療選択は担当医が判断',sev:'dn' as const},
