...
const CLASSES = [
  ...
  { rank: 'III（強い）', drugs: ['デキサメタゾンプロピオン酸エステル（メサデルム）', 'デプロドンプロピオン酸エステル（エクラー）', 'ベタメタゾン吉草酸エステル（リンデロンV/ベトネベート）', 'フルオシノロンアセトニド（フルコート）', 'ベクロメタゾンプロピオン酸エステル（プロパデルム）'] },
  { rank: 'IV（中程度）', drugs: ['トリアムシノロンアセトニド（ケナコルトA/レダコート）', 'アルクロメタゾンプロピオン酸エステル（アルメタ）', 'クロベタゾン酪酸エステル（キンダベート）', 'ヒドロコルチゾン酪酸エステル（ロコイド）'] },
  { rank: 'V（弱い）', drugs: ['プレドニゾロン（プレドニゾロン軟膏）', 'ヒドロコルチゾン酢酸エステル（コルテス）'] },
]
