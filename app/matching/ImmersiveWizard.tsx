...
const STEPS = [
  ...
  { id: 'specialty', icon: '🏥', question: '志望する診療科は？', sub: '複数選択可（まだ決まっていなくてもOK）',
    choices: ['内科','循環器内科','消化器内科','呼吸器内科','腎臓内科','内分泌・糖尿病内科','血液内科','神経内科','膠原病・リウマチ科','感染症科','腫瘍内科','外科','消化器外科','心臓血管外科','呼吸器外科','乳腺外科','小児科','産婦人科','整形外科','脳神経外科','皮膚科','眼科','耳鼻咽喉科','泌尿器科','精神科','放射線科','放射線治療科','麻酔科','救急科','総合診療科','リハビリテーション科','病理診断科','形成外科','小児外科','未定'],
